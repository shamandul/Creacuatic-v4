...
class Inicio extends Component {
  ...
  obtenerTodosCursos = async () => {
    let res = await fetch(
      process.env.REACT_APP_HOST_SERVER_API + "/cursos/all",
      {
        mode: "cors",
        headers: {
  ...
  obtenerTodasNoticias = async () => {
    let res = await fetch(
      process.env.REACT_APP_HOST_SERVER_API + "/noticias/all",
      {
        mode: "cors",
        headers: {
          "Access-Control-Allow-Origin": "*",
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        />
        <Ultimos title="Nuevos cursos" elementos={elementosCursos} />
        <UltimosModal elementos={elementosCursos} />
        <Ultimos title="Últimas noticias" elementos={elementosNoticias} />
        <UltimosModal elementos={elementosNoticias} />
        <Footer />
      </React.Fragment>
    );
  }
